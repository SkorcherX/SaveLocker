...
- **Status:** PoC complete + the **UX phase functionally done** — tray UX, game
  ...
  SteamGridDB cover art all built & verified. Remaining is polish + deploy hardening
  + productization (the SaveLocker rename, console redesign — see [[Console Redesign]]).
